...
public sealed class VulkanCommandBuffers
{
    ...
    public VulkanCommandBuffers(Vk vk, VulkanVirtualDevice device, VulkanSwapChain swapChain, VulkanCommandPool commandPool, VulkanIndexBuffer indexBuffer, VulkanVertexBuffer vertexBuffer, int indexCount)
    {
