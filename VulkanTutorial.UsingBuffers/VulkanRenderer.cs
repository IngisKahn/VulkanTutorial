...
public sealed class VulkanRenderer : IDisposable
{
    ...
    public VulkanRenderer(VulkanWindow window)
    {
        ...
        this.swapchain = new(this.vk, window.Window, this.instance, this.physicalDevice, this.device, in this.surface);
        ...
        this.commandBuffers = new(this.vk, this.device, this.swapchain, this.commandPool, this.indexBuffer, this.vertexBuffer, indices.Length);
    ...
    private void ResetSwapChain()
    {
        ...
        //    window.DoEvents();
        this.swapchain = new(this.vk, this.window.Window, this.instance, this.physicalDevice, this.device, in this.surface);

        this.commandBuffers = new VulkanCommandBuffers(this.vk, this.device, this.swapchain, this.commandPool, this.indexBuffer, this.vertexBuffer, indices.Length);
